...
import { Schema, compile, tokenizer, memo } from "fsm-tokenizer";
...
export type TokenType = typeof schema extends Schema<infer T, any> ? T : never

export function markup(strings: TemplateStringsArray, ...values: Array<any>) {
